...
//	fprintf (stderr,"%10.6lf %10.6lf %10.6lf\n", Rot[2][0], Rot[2][1], Rot[2][2]);
    ...
    */
	...
	for (int i=0; i<3; i++) {
	    ...
	    for (int j=0; j<3; j++) fprintf(cfp, " %10.4lf", avec[i][j]);
	    fprintf(cfp, "\n");
	}
...
char* atom=0;
	...
	if (!debug) {
	    ...
	    if (sympos==0) remove("symmetry.pos");
	}
